    ...
    for dataroot_subset in ["BioMotionLab_NTroje", "CMU", "MPI_HDM05"]:
        ...
        for phase in ["train", "test"]:
            ...
            for filepath in tqdm(filepaths):
                ...
                data["hmd_position_global_full_gt_list"] = (
                    hmd_position_global_full_gt_list
                )
...
def run():
    ...
    bm_fname_male = pathmgr.get_local_path(
        os.path.join(args.support_dir, "smplh/{}/model.npz".format("male"))
    )
    dmpl_fname_male = pathmgr.get_local_path(
        os.path.join(args.support_dir, "dmpls/{}/model.npz".format("male"))
    )
