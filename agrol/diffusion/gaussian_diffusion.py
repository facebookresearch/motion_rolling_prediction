...
class GaussianDiffusion:
    ...
    def p_sample_loop_progressive(
        ...
        for i in indices:
            ...
            deactivate_inpainting = i == indices[-1] and deactivate_last_inpainting
            if deactivate_inpainting:
                assert (
                    model_kwargs is not None
                    and "y" in model_kwargs
                    and "inpainting_mask" in model_kwargs["y"]
                ), "deactivate_last_inpainting is True but model_kwargs is not specified or does not contain inpainting_mask"
